...
assert(/css\/polish\.css\?v=9\.[7-9]/.test(indexHtml), 'Cache busting bumped to ?v>=9.7 for css');
assert(/js\/pages\/recordings\.js\?v=9\.[7-9]/.test(indexHtml), 'Cache busting bumped to ?v>=9.7 for recordings.js');
