...
assert(indexHtml.includes('css/polish.css?v=9.3'), 'Cache busting bumped to ?v=9.3 for css');
assert(indexHtml.includes('js/router.js?v=9.3'), 'Cache busting bumped to ?v=9.3 for js');
